...
We could factor out the side effects in `checkout` using MTL-style typeclasses, free monads, or [extensible-effects](https://hackage.haskell.org/package/extensible-effects-1.11.1.0). That said, in the next post I will show you a technique to tackle both the side effect and testability concerns, using MTL-style abstraction of the state machine itself. Stay tuned!
